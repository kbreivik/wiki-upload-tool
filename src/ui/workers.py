...
class FetchPagesWorker(QThread):
    """Background thread for fetching the wiki page list (for preview status)."""

    pages_fetched = Signal(list)
    failure = Signal(str)
